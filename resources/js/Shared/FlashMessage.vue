<template>
		<div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 bg-gray-lightest mb-2" style="padding-top: 1rem;">
				<div v-if="$page.props.flash.error">
						<div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 my-2 rounded relative" role="alert">
								...
								<span class="absolute top-0 bottom-0 right-0 px-4 py-3">
								    <svg class="fill-current h-6 w-6 text-red-500" role="button" @click="$inertia.reload()"
				...
				<div v-if="$page.props.flash.success">
						<div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 my-2 rounded relative"
						     role="alert">
